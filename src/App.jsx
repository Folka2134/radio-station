...
function App() {
  ...
  return (
    <div className="App bg-[url('./assets/plymouth.webp')] bg-fixed bg-cover min-h-screen relative min-w-[350px]">
      ...
      <div className="mx-6 lg:mx-72 z-10 relative">
        ...
        <div className="sticky top-0">
          {/* NAV */}
          <nav className="flex justify-end md:justify-between md:bg-[#1a3175] md:bg-opacity-90 text-gray-300  border-black border-opacity-40 rounded-xl mb-1">
          ...
          {/* PLAYER */}
          <div className="flex h-32 bg-black bg-opacity-90 rounded-xl mb-1 text-white border-2 border-black border-opacity-50 p-2">
