...
const Homepage = () => {
  ...
  return (
    <main className="myContainer flex flex-col justify-center items-center text-center">
      ...
      <div className="hidden lg:block h-[250px] 2xl:h-[250px] bg-[#242424] bg-opacity-90 text-white w-full rounded-3xl bg-[url('./assets/plymouth.webp')] bg-cover bg-top my-16"></div>
      {/* <NewsList /> */}
      {/* Weather */}
    </main>
  );
